...
export default function AdminPage() {
  ...
  return <main className="standalone">
    ...
    <header><p className="eyebrow">DOSSIER NOIR · V4</p><h1>Ajouter des statistiques</h1><p>Renseigne les chiffres de chaque plateforme. Le taux « ont continué à regarder » mesure directement la force du hook.</p></header>
