...
export function applyEditorialMetrics(video = {}) {
  ...
  return { ...video, dossier, ...studio, scrollStop: studio.scrollStop ?? video.scrollStop ?? null, retention: studio.retention ?? video.retention ?? null, completion: platform === "YouTube Shorts" ? null : (studio.completion ?? video.completion ?? null) };
}
